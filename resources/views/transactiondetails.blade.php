...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <a href="{{ route('home.index')}}" class="btn btn-sm btn-warning" style="margin-bottom: 20px">Home</a>
                <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="row">
                        <div class="col">{{ __('Detail Transaction') }}</div>
                        <div class="col text-end">
                            <a href="{{ route('category.index') }}" class="btn btn-sm btn-danger"><i class="fa fa-print" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            <tr>
                                <td class="col-md-2">Tanggal : {{ $transaction->created_at }}</td>
                            </tr>
                            <tr>
